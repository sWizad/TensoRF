...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['shiny','deepvv','blender','blender_predict', 'llff', 'nsvf', 'dtu','tankstemple','meta','meta_lazy', 'meta_dynamic', 'meta_crop', 'llff_cube',
                                'shiny_few1','shiny_few5','shiny_few10','shiny_few15','shiny_few20','shiny_fern400', 'llff_fern400', 'blender_depth', 'llff_blender', 'dreamfusion'
                        ])
    ...
    parser.add_argument("--TV_weight_app", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--TV_every", type=int, default=10,
                        help='TV loss')
